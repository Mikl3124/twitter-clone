const { getTweets, createTweet, deleteTweet, getTweet, updateTweet, getCurrentUserTweetsWhithFollowing } = require('../queries/tweets.queries');

exports.tweetList = async (req, res, next) => {
  try {
    const tweets = await getCurrentUserTweetsWhithFollowing(req.user);
...
exports.tweetNew = async (req, res, next) => {
  try {
    ...
    res.render('tweets/tweet-form', { tweet: {}, tweets, isAuthenticated: req.isAuthenticated(), currentUser: req.user, user: req.user });
  } catch(e) {
    next(e)
  }
